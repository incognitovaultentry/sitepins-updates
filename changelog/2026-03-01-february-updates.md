...
In February, we shipped several quality-of-life updates that streamline your daily workflow:

Here's everything we shipped this month:

- **Version Rollback & Restore** — Undo changes directly in the CMS.
- **Flexible Repository Switching** — Change your Git repository directly from the project settings.
...
> **Note:** Some features are only available for Pro users.
